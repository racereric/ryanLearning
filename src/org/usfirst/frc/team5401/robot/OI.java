...
public class OI {
	...
	//Buttons (Block 1 = Driver, Block 2 = Operator)
	...
	Button xboxY_Driver              =   new JoystickButton(xboxController_Driver, 3);
	Button xboxX_Driver              =   new JoystickButton(xboxController_Driver, 4);
	...
	Button xboxY_Operator            =   new JoystickButton(xboxController_Operator, 3);
	Button xboxX_Operator            =   new JoystickButton(xboxController_Operator, 4);
	...
	public OI() {
		...
		xboxX_Driver.whenPressed(new CompressorToggle());
	...
	public double readXboxLeftTrigger_Driver() {
		return xboxController_Driver.getRawAxis(RobotMap.LEFT_TRIGGER_AXIS);
	}
	
	public double readXboxRightTrigger_Driver() {
